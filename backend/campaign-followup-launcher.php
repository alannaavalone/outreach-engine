<?php
/**
 * Campaign Follow-Up Launcher
 *
 * Responsible for:
 * - batching leads
 * - orchestrating follow-up worker calls
...
$tag = 'React FU Campaign';

$maxCalls = 100;
$batchSize = 10;
$concurrency = 3;

$workerBase = getenv('WORKER_FOLLOWUP_URL');
...
function createCurlHandle($url, $connectTimeout, $requestTimeout) {
    ...
    curl_setopt_array($ch, [
        ...
        CURLOPT_USERAGENT => 'OutreachEngine-FollowUp/1.0',
    ]);
